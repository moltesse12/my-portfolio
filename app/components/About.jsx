      ...
      <div className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
        ...
        <div className="flex-1">
          <p className='mb-10 max-w-2xl font-Ovo'>
            Je suis un développeur passionné par la création d’expériences web modernes et performantes. Avec une solide expérience en JavaScript, React et Next.js, j’aime concevoir des interfaces intuitives et accessibles. Curieux et toujours en quête de nouveaux défis, je m’investis dans chaque projet pour offrir des solutions innovantes et adaptées aux besoins des utilisateurs.
          </p>
          ...
          <h4 className='my-6 text-gray-700 font-Ovo'>Mes Compétences</h4>
