    ...
    <>
      ...
      <nav
        className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 ${
          isScroll ? "bg-white bg-opacity-50 backdrop-blur-lg shadow-sm dark:shadow-white/20" : ""
        }`}
      >
        {/* <a href="#top">
          <Image src={isDarkMode ? assets.logo_dark : assets.logo} alt="" className="w-28 cursor-pointer mr-14" />
        </a> */}
        <a href="#top" className="mr-14 cursor-pointer text-4xl font-bold">
        ...
        <div className="flex items-center gap-4">
          ...
          >
            Contact{" "}
            <Image src={isDarkMode ? assets.arrow_icon_dark : assets.arrow_icon} className="w-3" />{" "}
          </a>
